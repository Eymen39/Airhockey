...
public class LobbyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(preferences.getString("MqTTBrokerUrl","null").equals("null")){
            Snackbar.make(findViewById(android.R.id.content),"Geben sie die MqTTBroker Url ein",Snackbar.LENGTH_LONG).show();
        }
