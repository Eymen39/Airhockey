...
public class CreateTurnierFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        broker= MqTTLoginData.getBrokerUrl(requireContext());
        password=MqTTLoginData.getPassword(requireContext());
        userName=MqTTLoginData.getMqttUsername(requireContext());
        ...
        //hier bekommt man den LobbyCode aus der TurnierLogik für das Turnier
